...
import { StarsReview } from "../Utils/StarsReveiw";
...
export const BookCheckoutPage = () => {
  ...
  useEffect(() => {
    const fetchBook = async () => {
      ...
      }; //Dùng để chuyển đổi dữ liệu API thành object có cấu trúc cụ thể (kiểu TypeScript).
  ...
  useEffect(() => {
    const fetchUserCurrentLoansCount = async () => {
      if (authState && authState.isAuthenticated) {
        ...
        console.log('Current loans count from API:', currentLoansCountResponseJson);
        setCurrentLoansCount(currentLoansCountResponseJson);
      } 
      // else {
      //   // Reset count to 0 when user is not authenticated
